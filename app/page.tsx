  ...
  return (
    <>
      <div className="container mx-auto py-20">
        ...
        <h1 className="title">Oskar Sjöbeck Berglund</h1>
        ...
        <div className="paragraph">
          Follow the onboarding steps to set up your workspace, define your
          types and auto generate domain classes.
        </div>
        <div className="mx-auto">
          <OnboardingStep
            title="Create an Account and Workspace"
            completed={workspaceIdSetupCompleted}
          >
            <div className="paragraph">
              Sign up and create a workspace on{" "}
              <Link
                href="https://app.starhive.com"
            ...
            <div className="paragraph">
              Copy your workspace id from the URL and set it up as an
          ...
          >
            <div className="paragraph">
              Navigate to the workspace settings page. Select Personal access
              token tab in the menu and create a new token.
            </div>
            <div className="flex flex-row flex-wrap justify-center">
              <Image
                src="/navigate_settings.png"
            ...
            <div className="paragraph">
              Copy your generated api token. Note that this is the only time you
              can see the token, after closing the popup it will disappear.
            </div>
            <div className="paragraph">
              Set up your api token as an environment variable.
            </div>
            <CodeBlock>{`export STARHIVE_API_TOKEN="api token"`}</CodeBlock>
          </OnboardingStep>

          <OnboardingStep
            title="Create Spaces and Types"
            completed={typeCreationCompleted}
          >
            <div className="paragraph">
              Create some spaces and types for your data model on{" "}
              <Link
                href="https://app.starhive.com"
                className="hover:underline text-blue-600"
              >
            ...
            <div className="flex flex-row flex-wrap justify-center">
              <Image
                src="/create_types.png"
                alt="Create Spaces and Types"
                width={700}
                height={200}
          ...
          <OnboardingStep
            ...
            completed={schemaGenerated}
          >
            <div className="paragraph">
              Navigate to API Connectors extension. Select your space and
              TypeScript language. Then press generate button.
            </div>
            <div className="flex flex-row flex-wrap justify-center">
              <Image
                src="/api_connectors.png"
                alt="Navigate to API Connectors extension"
                width={700}
                height={20}
                className="rounded-md mx-3 border-gray-300 border-2"
              />
              <Image
                src="/generate_schema.png"
                alt="Generate Schema"
                width={700}
                height={20}
                className="rounded-md mx-3 border-gray-300 border-2"
            ...
            <div className="paragraph">
              Copy files from{" "}
              <span className="path-highlight">src/io/starhive/schema</span> of
              the sample project into{" "}
              <span className="path-highlight">app/api/starhive/schema</span>
            ...
            <div className="paragraph">
              Go to ClientFactory.ts and replace{" "}
              <span className="path-highlight">new Map()</span> with{" "}
              <span className="path-highlight">JSON_DECODERS</span> constant
              imported from the schema directory.
            </div>

            <div className="paragraph">
              This would allow you to use domain types in your code without
              having to manually map type and attribute ids in your code.
            </div>
...
return new StarhiveClient(starhiveApiToken()!, starhiveWorkspaceId()!, JSON_DECODERS)
          ...
          <OnboardingStep title="Start Building" completed={false}>
            ...
            <div className="paragraph">Create an object using builder</div>
            <CodeBlock>
              {`
    const product = await client.createObject(
        Product.builder()
            ...
            <div className="paragraph">Search for objects</div>
            <CodeBlock>
              {`
    ...
    products.result.forEach(product => {
        console.log(product.getName(), product.getPrice())
            ...
            <div className="paragraph">Patch objects</div>
            <CodeBlock>
              {`
    ...
    await client!.createOrUpdateObjectsInBulk(toPatch)
            ...
            <div className="paragraph">
              ...
              <Link
                href="https://help.starhive.com/space/DOC"
                className="hover:underline text-blue-600"
              >
